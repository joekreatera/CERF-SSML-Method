...
def gower_distance_matrix(X,cat_cols , mn=None, mx = None):
    """
    Calculates the distance from every x_i in X to every other x_j in X. It generates the operations for (x_rows)(x_rows-1)/2 and copies the values to the rest of the matrix 
